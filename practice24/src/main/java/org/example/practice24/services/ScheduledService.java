package org.example.practice24.services;

import jakarta.annotation.PostConstruct;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.practice24.TaskMXBean;
...
public class ScheduledService implements TaskMXBean {
    ...
    public void remadeFiles() throws IOException {
        Files.walk(Path.of("practice23/src/main/resources/entities")).filter(Files::isRegularFile).forEach(p -> {
            try {
                Files.delete(p);
            } catch (IOException e) {
...
//        FileWriter productsFile = new FileWriter("practice23/src/main/resources/entities/products.txt");
//        productsFile.write(service.getProducts().toString());
//
//        FileWriter feedbacksFile = new FileWriter("practice23/src/main/resources/entities/feedbacks.txt");
